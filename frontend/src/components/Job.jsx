    ...
    return (
        <div className='p-5 rounded-md shadow-xl bg-white border border-gray-100'>
            <div className='flex items-center justify-between'>
                ...
                >
                    {isSaved ? (
                        <BookmarkCheck className="text-black fill-black" />
                    ) : (
                        <Bookmark />
                    )}
                </Button>
            ...
            <div className='flex text-center gap-2 mt-4 '>
                <Badge className={'text-blue-700 font-bold border-gray-150 rounded-full'} variant="ghost">{job?.position} Positions</Badge>
                <Badge className={'text-[#F83002] font-bold border-gray-150 '} variant="ghost">{job?.jobType}</Badge>
                <Badge className={'text-[#7209b7] font-bold border-gray-150 '} variant="ghost">{job?.salary}LPA</Badge>
            </div>
